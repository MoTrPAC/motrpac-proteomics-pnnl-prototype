...
motrpac-prot-masic:v1.2_20200901 bash step00/step00masic_phospho.sh
...
motrpac-prot-msgfplus:v1.2_20200901 bash step02/step02msgfplus_tryptic_phospho.sh

# Step 03a
sh step03/step03a_phospho.sh

# Step 03b
docker run -v $PWD/data:/data:rw \
-v $PWD/parameters:/parameters:rw \
-v $PWD/step03:/step03:rw \
motrpac-prot-ppmerror:v1.2_20200901 bash step03/step03b_phospho.sh

# Step 04
docker run -v $PWD/data:/data:rw \
-v $PWD/parameters:/parameters:rw \
-v $PWD/step04:/step04:rw \
motrpac-prot-msgfplus:v1.2_20200901 bash step04/step04msgfplus_phospho.sh

# Step 05
docker run -v $PWD/data:/data:rw \
-v $PWD/parameters:/parameters:rw \
-v $PWD/step05:/step05:rw \
motrpac-prot-mzid2tsv:v1.2_20200901 bash step05/step05net462_phospho.sh

# Step 06
docker run -v $PWD/data:/data:rw \
-v $PWD/parameters:/parameters:rw \
-v $PWD/step06:/step06:rw \
motrpac-prot-phrp:v1.2_20200901 bash step06/step06phrp_phospho.sh

# Step 07
docker run -v $PWD/data:/data:rw \
-v $PWD/parameters:/parameters:rw \
-v $PWD/step07:/step07:rw \
...
motrpac-prot-plexedpiper:v1.2_20200901 bash relquant/relquant_phospho.sh
